...
//     test("Then, the newBill icon should be heighlighted (in the left vertical bar)",async ()=> {
//       const root = document.createElement("div")
//       root.setAttribute("id", "root")
//       document.body.append(root)
//       router()
...
//       await waitFor(() => screen.getByTestId('icon-mail'))
//       const newBillIcon = screen.getAllByTestId("icon-mail");
//       expect(newBillIcon[0]).toHaveClass("active-icon")
